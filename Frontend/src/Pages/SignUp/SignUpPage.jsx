                ...
                <form className='w-80 max-w-screen-lg sm:w-96 m-auto'>
                    ...
                    <div className='flex flex-col gap-6'>
                        ...
                        <input
                            ...
                            className='bg-gray-50 border text-white border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 '
                        />
                        <label className='block text-sm font-medium text-gray-900  -mb-4'>
                            Your Username:
                        </label>
                        <input
                            ...
                            className='bg-gray-50 border text-white border-gray-300  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:'
                        />
                        <label className='block  text-sm font-medium text-gray-900  -mb-4'>
                            Your Email:
                        </label>
                        <input
                            ...
                            className='bg-gray-50 border border-gray-300 text-white  text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:'
                            onChange={(event) => {
